...
<template>
      ...
      <div style="height: 100%">
        <div class="tool_slider">
          <div style="display: flex; align-items: center">
            ...
            <el-tag style="float: right" :type="tag_style(jsonObj)">{{ jsonObj }}</el-tag>
          </div>
        </div>
  ...
  <script lang="ts" setup>
    ...
    //计算错误信息所在行列
    function getLineAndColumn(str: any, index: any) {
      let line = 1;
      let column = 1;
